package com.wildanka.moviecatalogue.presentation.ui.favorites.adapter
...
class FavoriteMovieCastAdapter : RecyclerView.Adapter<FavoriteMovieCastAdapter.MovieCastViewHolder>() {
    private var movieCast : List<MovieCast> = mutableListOf()
    fun setupMovieCastData(movieCast: List<MovieCast>){
